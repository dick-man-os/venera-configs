...
class Keiyoushi1163192659786040070Source extends ComicSource {
    ...
    catalog = async (kind, keyword, page) => {
        ...
        if (body === null) return {comics: [], hasMore: false};
        return {comics: this.unique(this.array(body.data).map(this.manga)), hasMore: this.pagination(body, offset)};
    };
    info = async id => {
